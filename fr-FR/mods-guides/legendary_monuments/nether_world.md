# 🔥🏗️ Structures légendaires du Nether

## 🌋 Grotte Zénith

{% hint style="info" %}
<p align="center">
Structure permettant d'obtenir <strong>Heatran</strong>.
</p>
{% endhint %}
...
- 📌 Dimension : Nether
- 🏗️ Peut apparaître n'importe où dans le Nether

***

## 🏛️ Sanctuaires des Fléaux

{% hint style="info" %}
<p align="center">
Structures permettant d'obtenir <strong>Chongjian</strong>, <strong>Baojian</strong>, <strong>Dinglu</strong> et <strong>Yuyu</strong>.
</p>
{% endhint %}

### 🧭 Aperçu rapide

- 🎯 Objectif : obtenir les Quatre Fléaux
- 🗺️ Gameplay : exploration et collecte de pieux
- ⚠️ Difficulté : moyenne
- 🎁 Loot : aucun

### 🧗 Particularités

- Chaque sanctuaire est dédié à un Pokémon légendaire.
- Pour l'activer, vous devez d'abord collecter les **8 Pieux** correspondant au sanctuaire.
- Les pieux peuvent apparaître dans n'importe quel biome du Nether.
