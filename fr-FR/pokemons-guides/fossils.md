...
Un fossile représente les restes d’un Pokémon ancien figé dans le temps.  
Une fois récupéré, il peut être traité grâce à une **machine de résurrection**.

🧭 Processus général :

1. 🔎 Trouver un fossile lors de l’exploration
2. 🖌️ L’extraire à l’aide d’un pinceau si nécessaire
3. 🧪 Le placer dans une machine de résurrection
4. ⚡ Alimenter la machine (avec de la nourriture)
5. 🐣 Récupérer le Pokémon ressuscité
...
- 🧱 Blocs suspects (sable et gravier)
- 🏛️ Structures anciennes
- 🌍 Zones spécifiques selon le biome

Chaque fossile est associé à des **environnements précis**, rendant certains Pokémon plus rares que d’autres.
