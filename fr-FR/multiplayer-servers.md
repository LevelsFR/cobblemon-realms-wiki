...
Vous pouvez rejoindre **n'importe quel serveur compatible avec la version actuelle de Cobblemon Realms**. Avant de vous connecter, vérifiez simplement que votre installation correspond bien à celle du serveur.

| 📦 Vérification | ✅ À avoir |
| --- | --- |
| **Modpack** | La même version que le serveur |
| **Java** | **Java 21** |
| **Client** | Une installation compatible avec le serveur |
...
| 🔓 **Port** | `25565` si le serveur est accessible depuis Internet |
