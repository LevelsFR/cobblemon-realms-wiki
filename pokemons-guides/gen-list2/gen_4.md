...
Then use the `Proof of Conquest (U)` to summon Uxie, with a **2% chance of it being Shiny**.
...
![Mesprit](https://raw.githubusercontent.com/LevelsCraft7/cobblemon-realms-wiki/refs/heads/main/imgwiki/Myth_Legends/gen_4/mesprit.png) ![Mesprit Shiny](https://raw.githubusercontent.com/LevelsCraft7/cobblemon-realms-wiki/refs/heads/main/imgwiki/Myth_Legends/gen_4/mesprit_shiny.png)
...
Then use the `Proof of Conquest (M)` to summon Mesprit, with a **2% chance of it being Shiny**.
...
> It is said to have brought people emotions such as joy and sadness.
...
![Azelf](https://raw.githubusercontent.com/LevelsCraft7/cobblemon-realms-wiki/refs/heads/main/imgwiki/Myth_Legends/gen_4/azelf.png) ![Azelf Shiny](https://raw.githubusercontent.com/LevelsCraft7/cobblemon-realms-wiki/refs/heads/main/imgwiki/Myth_Legends/gen_4/azelf_shiny.png)
...
To obtain Azelf, you must find the `Lake of Courage`

In the lake's cave, defeat all the Pokémon summoned by the `Cobblemon Trial Spawner` to obtain the `Proof of Conquest (A)`.

Then use the `Proof of Conquest (A)` to summon Azelf, with a **2% chance of it being Shiny**.
...
> It is said to have granted people the courage to face all hardships.
...
> By controlling the bonds of space, it can travel to distant locations or other dimensions.
...
> The blood of this crater-dwelling Pokémon boils inside its body like magma.
...
> It is said to have created Regirock, Regice, and Registeel using clay, ice, and magma respectively.
...
> It lives in the Distortion World, a world opposite to ours that defies common sense.
...
> Sleeping while holding one of its feathers is said to bring pleasant dreams. It is nicknamed the « avatar of the crescent moon. »
...
> It puts humans and Pokémon to sleep and gives them nightmares to drive them away from its territory.
...
> Sinnoh mythology says it emerged as an egg and created the world.
